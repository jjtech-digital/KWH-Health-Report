export const healthData = [
  {
    ...
    reliability: {
      ...
      top_failed_pages: [
        {
          path: "/frontastic/action/cart/AddToCart",
          failures: 54,
          status: 400,
        },
        {
    ...
    ecommerce: {
      total_orders: 10000,
      payment_failures_declined: 6,
      payment_failures_approved: 37,
      active_carts: 48048,
    },
    customers: {
      first_time_buyers: 454,
      returning_customers: 280,
      guest_checkouts: 0,
      registered_user_orders: 10000,
      total_registered_users: 1726,
  ...
  },
  {
    ...
    reliability: {
      ...
      top_failed_pages: [
        {
          path: "/frontastic/action/checkout/riskifiedDecide",
          failures: 59,
          status: 400,
        },
        {
    ...
    ecommerce: {
      total_orders: 7888,
      payment_failures_declined: 0,
      payment_failures_approved: 25,
      active_carts: 39144,
    },
    customers: {
      first_time_buyers: 436,
      returning_customers: 187,
      guest_checkouts: 0,
      registered_user_orders: 7886,
      total_registered_users: 1238,
  ...
  },
  {
    ...
    traffic: {
      ...
      top_pages: [
        ...
        { path: "/search", views: 7251 },
        {
          path: "/product/wolstead-14-in-1-cookmaster-multi-cooker-air-fryer-8l",
          views: 5805,
        },
        {
          path: "/product/wolstead-swift-glass-4-in-1-air-fryer-matte-black",
          views: 4952,
        },
      ],
      browsers: [
    ...
    ecommerce: {
      total_orders: 10000,
      payment_failures_declined: 0,
      payment_failures_approved: 26,
      active_carts: 42915,
    },
    customers: {
      first_time_buyers: 462,
      returning_customers: 237,
      guest_checkouts: 743,
      registered_user_orders: 9510,
      total_registered_users: 1656,
  ...
  },
  {
    ...
    traffic: {
      ...
      top_pages: [
        { path: "/", views: 15393 },
        { path: "/search", views: 9357 },
        {
          path: "/roduct/salisbury-co-capri-dinner-set-12pc-navy",
          views: 4041,
        },
        {
          path: "/product/wolstead-14-in-1-cookmaster-multi-cooker-air-fryer-8l",
    ...
    ecommerce: {
      total_orders: 10000,
      payment_failures_declined: 0,
      payment_failures_approved: 18,
      active_carts: 45363,
    },
    customers: {
      first_time_buyers: 448,
      returning_customers: 255,
      guest_checkouts: 2901,
      registered_user_orders: 7245,
  ...
  },
  {
    ...
    traffic: {
      ...
      top_pages: [
        { path: "/", views: 62780 },
        { path: "/search", views: 8992 },
        {
          path: "/product/kitchen-pro-versalock-glass-container-set-12pc-white",
          views: 7747,
        },
        {
          path: "/blog/recipes/chicken-cassoulet",
          views: 6986,
        },
        {
          path: "/product/wolstead-bliss-soft-serve-and-slushy-maker-1-8l-white",
    ...
    customers: {
      ...
      guest_checkouts: 2312,
      registered_user_orders: 6519,
      total_registered_users: 1567,
      conversion_rate: "1.96%",
    },
    web_vitals: {
      desktop: {
  ...
  },
  {
    ...
    traffic: {
      ...
      top_pages: [
        { path: "/", views: 59949 },
        { path: "/search", views: 10321 },
        {
          path: "/product/wolstead-palette-sm-stand-mixer-mulberry",
          views: 5852,
        },
        {
          path: "/blog/recipes/pear-almond-breakfast-muffins",
          views: 5123,
        },
        {
          path: "/product/wolstead-bliss-soft-serve-and-slushy-maker-1-8l-white",
    ...
    ecommerce: {
      total_orders: 9315,
      payment_failures_declined: 1,
      payment_failures_approved: 14,
      active_carts: 220517,
    },
    customers: {
      first_time_buyers: 466,
      returning_customers: 223,
      guest_checkouts: 2439,
      registered_user_orders: 6876,
      total_registered_users: 1796,
      conversion_rate: "1.93%",
    },
    web_vitals: {
      desktop: {
        lcp: "2.6s",
  ...
  },
  {
    ...
    traffic: {
      ...
      top_pages: [
        ...
        {
          path: "/product/wolstead-harvest-long-grain-chopping-board-set-2pc",
          views: 2910,
        },
      ],
      browsers: [
    ...
    customers: {
      first_time_buyers: 423,
      returning_customers: 242,
      guest_checkouts: 2306,
      registered_user_orders: 6590,
      total_registered_users: 1636,
      conversion_rate: "2.06%",
    },
    web_vitals: {
      desktop: {
  ...
  },
  {
    ...
    ecommerce: {
      total_orders: 7942,
      payment_failures_declined: 10,
      payment_failures_approved: 6,
      active_carts: 665855,
    },
    customers: {
      first_time_buyers: 465,
      returning_customers: 178,
      guest_checkouts: 2113,
      registered_user_orders: 5829,
      total_registered_users: 1360,
      conversion_rate: "1.93%",
    },
    web_vitals: {
      desktop: {
